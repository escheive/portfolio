        ...
        <Box className='about-me-page' align='center' sx={{ my: 8 }}>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap-reverse', justifyContent: 'center', mb: 5}}>
                <Box sx={{ maxWidth: '30vw', minWidth: '300px', mr: 2, my: 'auto' }}>
                    ...
                    <Typography sx={{ lineHeight: '32px'}} variant="body1" color="text.secondary">
                        A large part of me belongs to basketball. Ever since I was in 4th grade, I have loved the game. It consumed much of my free time after school. Instead of hanging out with friends or playing video games, I was in the gym, chasing my dreams. It was enough to get me to college. I played two years of collegiate basketball at Chaminade University of Honolulu. You can read more about my college career <a href='https://goswords.com/sports/mens-basketball/roster/erik-scheive/4465' target='_blank' rel='noreferrer'>here</a>. After I graduated college, I pursued my lifelong dream of playing basketball and played a season in the ProA league in Germany. You can read more about my professional career <a href='https://www.proballers.com/basketball/player/182731/erik-scheive' target='_blank' rel='noreferrer'>here</a>.
                    </Typography>
                </Box>
                <Box sx={{ mb: 5 }}>
                    <Image
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center'}}>
                ...
                <Box sx={{ maxWidth: '30vw', minWidth: '300px', ml: 2, my: 'auto' }}>
                    ...
                    <Typography sx={{ lineHeight: '32px'}} variant="body1" color="text.secondary">
                        I love getting out in nature in my free time. I love going on hikes and taking my camera or drone and getting some amazing shots. Washington is a beautiful state so I never run out of places to explore. If you want to see more of my photos, check out my <Link to='/photos'>photos</Link> page!
                    </Typography>
                </Box>
            </Box>
